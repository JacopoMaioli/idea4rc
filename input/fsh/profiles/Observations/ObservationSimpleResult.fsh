...
Invariant: obs-valueOftype-codeable
Description: "If the type is invasion into the fascia is a CodeableConcept"
Severity:    #warning
Expression:  "(code = 36768749 )  implies value.meberOf(http://hl7.eu/fhir/ig/idea4rc/ValueSet/mitotic-index-athena-vs).exists()"

Invariant: obs-valueOftype-codeable
Description: "If the type is Epstein Barr virus DNA [Units/volume] (viral load) in Serum or Plasma by NAA with probe detection or C reactive protein [Presence] in Serum or Plasma then the value is a CodeableConcept""
Severity:    #warning
